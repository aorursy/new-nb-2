...
hardcoded_countries = {"Korea, South": 51269000, "Diamond Princess": 3711, "Taiwan*": 23800000, 

  "Saint Vincent and the Grenadines": 109897,"Congo (Brazzaville)":5261000,

   "Congo (Kinshasa)":81340000, "Cote d'Ivoire":24300000, "Czechia": 10650000, "Saint Kitts and Nevis": 55345}
...
def visualize_country(country_name, val_info_dict=val_info_dict):
  ...
  plt.show()
def get_country_data(country_name, province_name=None):
...
def train_val_country(country_name):
...
for country in tqdm(train['Country_Region'].unique()):
  ...
  #If we don't have any provinces for this country
    ...
    try:
      ...
      print(country)
visualize_country("Hubei")
# submission date range: 19Mar20-30Apr20

pd_daterange_submission = pd.date_range('19Mar20', "30Apr20")
