...
def get_image_id_from_path(image_path):
    ...
    return image_path.split('../input/open-images-2019-instance-segmentation/test/')[1].split('.jpg')[0]
# quick sanity check
...
predictions_df
submission_df = pd.read_csv('../input/open-images-2019-instance-segmentation/sample_truncated_submission.csv')
