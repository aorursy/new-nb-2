...
print (os.listdir('../input/bertconfig'))
...
model.load_state_dict(torch.load("../input/bertconfig/bert_pytorch.bin"))
...
'prediction': lstm_submission['prediction'].rank(pct=True)*0.337 + bert_submission['prediction'].rank(pct=True)*0.663})
