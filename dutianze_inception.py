...
retina_df[['level_a', 'eye']].hist(figsize = (10, 5))
retina_df[['level_b', 'eye']].hist(figsize = (10, 5))
...
train_df = raw_train_df.groupby(['level_a', 'eye']).apply(lambda x: x.sample(75, replace = True)

                                                      ).reset_index(drop = True)

print('New Data Size:', train_df.shape[0], 'Old Size:', raw_train_df.shape[0])

train_df[['level_a', 'eye']].hist(figsize = (10, 5))
...
valid_gen = flow_from_dataframe(valid_idg, valid_df, 
                            ...
                            y_col = 'level_cat_a') # we can use much larger batches for evaluation
