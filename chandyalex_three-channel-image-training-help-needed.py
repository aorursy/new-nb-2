...
tmp_img = np.zeros((img_size_target, img_size_target,3), dtype=train_df.images.loc[ids_train[10]].dtype)
...
def lovasz_loss(y_true, y_pred):
    y_true, y_pred = K.cast(K.squeeze(y_true, -3), 'int32'), K.cast(K.squeeze(y_pred, -1), 'float32')
