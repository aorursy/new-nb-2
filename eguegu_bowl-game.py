...
train_installation_id = train['installation_id'].values.tolist()

a = len(set(train_installation_id))

print(a)
test_installation_id = test['installation_id'].values.tolist()

not_duplicated_installation_id = list(set(test_installation_id))
# import random
...
# accuracy_group = [random.choice(accuracy) for i in range(len(not_duplicated_installation_id))]



# submission = pd.DataFrame(columns=['installation_id', 'accuracy_group'])



# submission = pd.DataFrame({

#     'installation_id': not_duplicated_installation_id,

#     'accuracy_group': accuracy_group

#     })

# submission.installation_id = submission.installation_id.astype(str)
