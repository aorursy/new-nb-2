...
for e in range(epoch):
    ...
    for image, mask in notebook.tqdm(data.DataLoader(dataset, batch_size = 30, shuffle = True)):
...
for image in notebook.tqdm(data.DataLoader(test_dataset, batch_size = 30)):
...
for image, mask in notebook.tqdm(data.DataLoader(dataset_val, batch_size = 30)):
