...
train_img = pd.read_csv("../input/extractimagefeaturesfrompretrainednn/train_img_features.csv")

test_img = pd.read_csv("../input/extractimagefeaturesfrompretrainednn/test_img_features.csv")
