...
plt.xlabel('Top 10 aisles', size=15)
plt.ylabel('Total products per aisle', size=15)
# Modify the limits
plt.ylim(0,1400)
plt.show()
...
plt.xlabel('10 lowest products ',size=15)
plt.ylabel('Mean add to cart order',size=15)
plt.show()