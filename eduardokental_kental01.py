...
# Verificando o dataframe após transformações
...
sns.despine(left=True)
# Avaliando características jornada_trabalho

sns.set(rc={'figure.figsize':(14.7,6.27)})

sns.swarmplot(x='regiao', 

              y='ct_jornada_trabalho', 

              data=df,

              hue='ds_jornada_trabalho')
...
plt.ylabel('Jornada de Trabalho',labelpad=10)
