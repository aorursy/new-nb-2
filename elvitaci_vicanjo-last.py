...
def preprocess (dataset):
    ...
    processed_dataset[d-1]=processed_dataset['Revenue'].shift(1)

    processed_dataset[d-2]=processed_dataset['Revenue'].shift(2)

    processed_dataset[d-3]=processed_dataset['Revenue'].shift(3)

    processed_dataset[d-1]=processed_dataset['Revenue'].shift(4)
...
x_train = train_data[["Date","Revenue-1","Revenue-2","Revenue-3","Revenue-4","Revenue-5"]]

x_train
y_train = train_data[["Date","Revenue"]]

y_train
x_test = train_data[["Date","Revenue-1","Revenue-2","Revenue-3","Revenue-4","Revenue-5"]]

x_test
y_test = train_data[["Date","Revenue"]]
