...
df_country = df_val[(df_val['Country_Region'] == country)&(df_val['Province_State']== province)]

idx = df_country[((df_country['ConfirmedCases'].isnull() == False) & (df_country['ConfirmedCases'] > 0))].shape[0]

fig = px.line(df_country, x="Date", y="ConfirmedCases_hat", 

              title='Total Cases of ' + df_country['Country_Region'].values[0] + ' ' + df_country['Province_State'].values[0])
...
fig = px.line(df_country, x="Date", y="Fatalities_hat", 

              title='Total Fatalities of ' + df_country['Country_Region'].values[0] + ' ' + df_country['Province_State'].values[0])
