...
# replace 2016 tax variables with 2015's for 2016Q4 prediction

properties = pd.read_csv(directory +'properties_2017.csv')

properties2016 = pd.read_csv(directory +'properties_2016.csv')

properties[['structuretaxvaluedollarcnt', 'taxvaluedollarcnt', 'landtaxvaluedollarcnt', 'taxamount']]=properties2016[['structuretaxvaluedollarcnt', 'taxvaluedollarcnt', 'landtaxvaluedollarcnt', 'taxamount']] 





train2016 = pd.read_csv(directory +"train_2016_v2.csv")

train2017 = pd.read_csv(directory +"train_2017.csv")

    

train = pd.concat([train2016, train2017], ignore_index=True)
...
sub.to_csv('2016Q4.csv',index=False)
# import output xxx.csv.gz from Genetic Programming for 2017Q4 Prediction

import urllib.request

urllib.request.urlretrieve ('https://www.kaggle.com/danieleewww/genetic-programming-for-2016q4?scriptVersionId=1577488/output/2017Q4.csv', 'pred_2017Q4.csv')