...
products = pd.read_csv('../input/products.csv')
products[products.product_id== 7816 ]

### step 8 - Create a sns.barplot for the 10 products with the lowest mean_add_to_cart_order
avg_pos_asc10 = avg_pos_asc.iloc[0:10]
plt.figure(figsize=(12,8))
sns.barplot(avg_pos_asc10.index, avg_pos_asc10.mean_add_to_cart_order, order=avg_pos_asc10.index)
plt.xlabel('10 Products_ids with the lowest mean add to cart order')
