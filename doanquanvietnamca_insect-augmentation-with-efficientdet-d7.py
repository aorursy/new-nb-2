...
def get_net(best_weight=None, checkpoint_path=None, validation=False, test=False):
...
net = get_net(None, "../input/wheatfold4/best-checkpoint-fold4-0.40127.bin", test = True)
class BaseWheatTTA:
