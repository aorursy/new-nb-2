# [355]	train-mlogloss:0.352646	test-mlogloss:0.547696 with no improvements
import os
...
train_df["price_t"] = train_df["price"]/train_df["latitude"] +train_df["price"]/train_df["longitude"]

test_df["price_t"] = test_df["price"]/test_df["latitude"] +test_df["price"]/test_df["longitude"]
...
out_df.to_csv("xgb_starter3.csv", index=False)