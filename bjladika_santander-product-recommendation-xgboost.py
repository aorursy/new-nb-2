...
def processDataMK(in_file_name, cust_dict, lag_cust_dict):
    ...
    for row in csv.DictReader(in_file_name):
        ...
        #получение кода покупателя ndcopers
        ...
        #судя по всему занос данных покупателя в cust_dict, если его дата покупки совпадает с указанной датой
        ...
        if row['fecha_dato'] == '2016-06-28':
            ...
            #Получение списка полученных "покупок" в прошлом году (зачем правда) покупателем через функцию getTarget(row)
            target_list = getTarget(row)
            
            #данные одного row
            #([('fecha_dato', '2015-01-28'), ('ncodpers', '1375586'), ('ind_empleado', 'N'), ('pais_residencia', 'ES'), ('sexo', 'H'), ('age', ' 35'), ('fecha_alta', '2015-01-12'), 
            #('ind_nuevo', ' 0'), ('antiguedad', '      6'), ('indrel', ' 1'), ('ult_fec_cli_1t', ''), ('indrel_1mes', '1.0'), ('tiprel_1mes', 'A'), ('indresi', 'S'), ('indext', 'N'), 
            #('conyuemp', ''), ('canal_entrada', 'KHL'), ('indfall', 'N'), ('tipodom', ' 1'), ('cod_prov', '29'), ('nomprov', 'MALAGA'), ('ind_actividad_cliente', ' 1'), 
            #('renta', '87218.1'), ('segmento', '02 - PARTICULARES'), ('ind_ahor_fin_ult1', '0'), ('ind_aval_fin_ult1', '0'), ('ind_cco_fin_ult1', '1'), ('ind_cder_fin_ult1', '0'), 
            #('ind_cno_fin_ult1', '0'), ('ind_ctju_fin_ult1', '0'), ('ind_ctma_fin_ult1', '0'), ('ind_ctop_fin_ult1', '0'), ('ind_ctpp_fin_ult1', '0'), ('ind_deco_fin_ult1', '0'), 
            #('ind_deme_fin_ult1', '0'), ('ind_dela_fin_ult1', '0'), ('ind_ecue_fin_ult1', '0'), ('ind_fond_fin_ult1', '0'), ('ind_hip_fin_ult1', '0'), ('ind_plan_fin_ult1', '0'), 
            #('ind_pres_fin_ult1', '0'), ('ind_reca_fin_ult1', '0'), ('ind_tjcr_fin_ult1', '0'), ('ind_valo_fin_ult1', '0'), ('ind_viv_fin_ult1', '0'), ('ind_nomina_ult1', ' 0'), 
            #('ind_nom_pens_ult1', ' 0'), ('ind_recibo_ult1', '0')])
            
            #кроч примерно идет че покупал в 2015 году 28 июня чувак, и идет осмотр че он покупал в 2015 28 мая, и потом борьба max(кто больше и меньше)
            #zip = пробег по спискам, типо zip([1,2,3] и [4,5,6]) будет выдавать 1/4, 2/5 и 3/6 
...
# извлечение трейна и теста как csv
with zipfile.ZipFile("/kaggle/input/santander-product-recommendation/test_ver2.csv.zip","r") as z:
    z.extractall(".")
with zipfile.ZipFile("/kaggle/input/santander-product-recommendation/train_ver2.csv.zip","r") as z:
    z.extractall(".")
#Данный пример взят из https://www.kaggle.com/hachemsfar/xgboost
