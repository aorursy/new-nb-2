...
plt.show()
#μηπως εχει γινει καποιο λαθος? αφου το order_volume  εχει ηδη value_count πως θα γινει και countplot? μηπως θελετε ενα σκετο plot me pandas?
plt.figure(figsize=(15,5))
graph = sns.countplot(order_volume)
graph.set( xticks=list( range(0,101,4) ), xticklabels=list( range(0,101,4) ) )
plt.show()