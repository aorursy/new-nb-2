...
net.eval();
checkpoint.keys()
# Random rotation leads to 0.906 LB and doesn't work.
...
submissions[0]['Label'] = (submissions[0]['Label']*11 + submissions[1]['Label']*3 + submissions[2]['Label']*3 + submissions[3]['Label'])/20
